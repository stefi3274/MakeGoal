    ...
    <footer style={{background:'#1a1a1a',color:'#e5e7eb',padding:'32px 16px',marginTop:'48px'}}>
      <div style={{maxWidth:'960px',margin:'0 auto'}}>
        <div style={{display:'flex',flexWrap:'wrap',gap:'24px',justifyContent:'space-between',marginBottom:'24px'}}>
          <div>
            <h4 style={{color:VIOLET,fontWeight:900,fontSize:'18px',marginBottom:'8px'}}>MakeGoal</h4>
            <p style={{fontSize:'13px',color:'#9ca3af',margin:0}}>Plateforme de pronostics<br/>pour parieurs intelligents.</p>
          ...
          <div>
            ...
            <ul style={{listStyle:'none',padding:0,margin:0,fontSize:'13px',lineHeight:'1.8'}}>
              ...
              <li><a href="/jeu-responsable" style={{color:'#e5e7eb',textDecoration:'none'}}>Jeu responsable</a></li>
            </ul>
          </div>
          <div>
        ...
        <div style={{borderTop:'1px solid #374151',paddingTop:'16px',display:'flex',flexWrap:'wrap',gap:'12px',justifyContent:'space-between',alignItems:'center'}}>
          ...
          <p style={{fontSize:'12px',color:VIOLET,fontWeight:700,margin:0}}>18+ — Jouer comporte des risques. Jouez avec modération.</p>
        </div>
      </div>
    </footer>
  );
