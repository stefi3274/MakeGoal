        ...
        {vue === 'nouveau' && (
          <div style={{background:'#1a1a1a',border:'1px solid #333',borderRadius:'12px',padding:'24px'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',marginBottom:'14px'}}>
              <div><label style={labelStyle}>Équipe 1</label><input value={equipe1} onChange={e => setEquipe1(e.target.value)} placeholder="France" style={inputStyle}/></div><div><label style={labelStyle}>Équipe 2</label><input value={equipe2} onChange={e => setEquipe2(e.target.value)} placeholder="Argentine" style={inputStyle}/></div>
            </div>
                ...
                {c.statut !== 'termine' && (
                  <div style={{background:'#222',borderRadius:'10px',padding:'16px'}}>
                    ...
                    <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'8px',marginBottom:'10px'}}>
                      ...
                      <div><label style={labelStyle}>Score {c.equipe2}</label><input type="number" min={0} value={resultats[c.id]?.sa || ''} onChange={e => setResultats({...resultats, [c.id]: {...resultats[c.id], r1x2: resultats[c.id]?.r1x2||'', sh: resultats[c.id]?.sh||'', sa: e.target.value, buteurs: resultats[c.id]?.buteurs||''}})} style={inputStyle}/></div></div>
