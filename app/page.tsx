...
export default function Home() {
  ...
  return (
    <div style={{minHeight:'100vh',background:'#ffffff',color:'#111111',fontFamily:'sans-serif'}}>
      <header style={{background:'#ffffff',borderBottom:'3px solid #bf00ff',padding:'12px 24px',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        <div>
          <h1 style={{color:'#bf00ff',fontWeight:'900',fontSize:'20px',margin:0}}>MakeGoal</h1>
        ...
        <nav style={{display:'flex',gap:'16px',fontSize:'14px',fontWeight:'600'}}>
          <a href="#" style={{color:'#bf00ff'}}>Matchs</a>
          <a href="#" style={{color:'#6b7280'}}>Pronostics</a>
          <a href="#" style={{color:'#6b7280'}}>Stats</a>
        </nav>
      </header>
      <section style={{background:'#bf00ff',color:'#ffffff',textAlign:'center',padding:'64px 16px'}}>
        <h2 style={{fontSize:'40px',fontWeight:'900',marginBottom:'16px'}}>Jouez intelligemment.</h2>
        <button style={{background:'#ffffff',color:'#bf00ff',fontWeight:'900',padding:'12px 40px',borderRadius:'999px',border:'none',cursor:'pointer'}}>Voir les matchs</button>
      </section>
        ...
        {matches.map((match) => (
          <div key={match.idEvent} style={{border:'1px solid #e5e7eb',borderRadius:'16px',padding:'16px',marginBottom:'12px'}}>
            ...
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
              ...
              <p style={{color:'#bf00ff',fontWeight:'900'}}>VS</p>
